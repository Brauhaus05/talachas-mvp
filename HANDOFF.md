...
## Phase 6 cycle 3 — what shipped (disputes queue, branch `feat/phase6-disputes-queue`, PR pending 2026-07-07)
...
**Recommended order:** first **merge the cycle-3 disputes PR** (pending), then the owner **browser passes** still outstanding across cycles 1–3 (review CTA, admin panel, disputes flow). Before onboarding any real (non-seed) talacheros, resolve the **🚨 MX platform Stripe account** blocker (below), then the **talachero self-service tooling** and **neighborhood `ST_DWithin` search**. Cancellation-policy tiers can land whenever partial refunds are wanted.
